...
<div class="card bg-light text-dark">
        <div class="card-header">
            <h1 style="text-align:center;">Kelas Android Part-2</h1>
        </div>
<div class="container">
  <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-12">
            <br><h1>Android</h1>
            <p>Pada bagian kedua ini akan menjelaskan mengenai penggunaan activity seperti JAM</p>
<br>
<h4>Coba Download Source Code berikut : </h4>
  <a href="Jam1.rar" download="SourceCodeAndroid2.rar">
  <button class="btn1"><i class="fa fa-download"></i> Download</button></a>

  <h2>Video Pengenalan</h2>
    <iframe width="900" height="505" src="https://www.youtube.com/embed/nr5y6zjPj5c" allowfullscreen>
    </iframe>        
          </div>
