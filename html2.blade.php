...
<div class="card bg-light text-dark">
        <div class="card-header">
            <h1 style="text-align:center;">Kelas HTML Part-2</h1>
        </div>
<div class="container">
  <div class="container marketing">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <p>HTML Menggunakan tag html body dan lain lain dan ada juga yang dikenal dengan CSS dimana CSS ini akan mengatur tampilan dari website yang kita buat</p>
<br>
<h4>Coba Download Source Code berikut : </h4>
  <a href="coba.html" download="SourceCodeHTML.html">
  <button class="btn1"><i class="fa fa-download"></i> Download</button></a>

  <h2>Video Pengenalan</h2>
    <iframe width="900" height="505" src="https://www.youtube.com/embed/kpa2ab1sYio" allowfullscreen>
    </iframe>        
          </div>
  ...
  <div class="media border p-3">
    ...
    <div class="media-body">
      <h4>Alfin Gosal <small><i>Diposting 2 Maret 2020</i></small></h4>
  ...
  <div class="row">
          <div class="col-sm-3">
            ...
            <h4>HTML part-1</h4>
            <p><a class="btn btn-secondary" href="{{ url('/html1') }}" role="button">Buka &raquo;</a></p>
          </div>
